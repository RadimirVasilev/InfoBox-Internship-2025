namespace Doctor_Codenstein
{
    public partial class Form1 : Form
    {
        ...
        {
            // В случай, че ListBox-а няма нищо.
            if(lb_Ingridients.Text.Contains(""))
            {
                MessageBox.Show("Моля въведете съставки!" , "Няма съставки", MessageBoxButtons.OKCancel, MessageBoxIcon.Stop);
            }
            ...
            else if (lb_Ingridients.Items.Contains("котешка козина") && lb_Ingridients.Items.Contains("течен азот"))
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (lb_Ingridients.Text.Contains(""))
            {
                MessageBox.Show("Няма какво да се премахне!!", "Няма съставки", MessageBoxButtons.OKCancel, MessageBoxIcon.Stop);
            }
            else 
            {
